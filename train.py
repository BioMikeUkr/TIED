...
def main(args):
    ...
    # Create DataLoader
    train_dataset = TIEDDataset(dataset, tokenizer, image_transform, max_length=args.max_length)
    ...
    trainer = TIEDTrainer(
        ...
        args={
            ...
            "max_steps": -1,  # Use num_epochs and dataset size to determine steps
...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_data", type=str, help="Path to training data file", default= "dataset")
    ...
    parser.add_argument("--decoder_hidden_size", type=int, default=128, help="Hidden size for the decoder")
    ...
    parser.add_argument("--decoder_intermediate_size", type=int, default=256, help="Intermediate size for the decoder")
    parser.add_argument("--decoder_max_position_embeddings", type=int, default=64, help="Max position embeddings for the decoder")
